				...
				<div class="col col-8 p-4 bg-light">
					<form action="action.php" method="POST">
						...
						<div class="form-group mb-2">
							...
							<input name="name" id="name" class="form-control" type="text" placeholder="Nomor Induk Siswa" required>
						</div>
						<div class="form-group mb-2">
							...
							<div class="form-check">
								<input class="form-check-input" type="radio" name="gender" id="male" value="P" required>
						...
						<div class="form-group mb-2">
							...
							<input name="dateOfBirth" id="name" class="form-control" type="date" required>
						</div>
						<div class="form-group mb-2">
